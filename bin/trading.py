...
def createIndicators(prices):
    ...
    slowk, slowd = talib.STOCH(highPrice, lowPrice, closePrice, fastk_period=5, slowk_period=3, slowk_matype=0, slowd_period=3, slowd_matype=0)
    
    # return numpy.column_stack((sma, real, macd, macdsignal, macdhist, upperband, middleband, lowerband)), longestPeriod
    return numpy.column_stack((prices, ema, rsi, upperband, middleband, lowerband, adx, slowk, slowd)), 30
